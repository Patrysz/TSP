   ...
   public class AntColonyProgram
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                int[][] dists = MakeGraphDistancesDemo(numCities);
       ...
       public static double Length(int[] trail, int[][] dists) // total length of a trail
        {
            double result = 0.0;
        ...
        public static int[] BestTrail(int[][] ants, int[][] dists) // best trail has shortest total length
        {
       ...
       public static double[][] InitPheromones(int numCities)
        {
       ...
       public static int NextCity(int k, int cityX, bool[] visited, double[][] pheromones, int[][] dists)
        {
       ...
       public static double[] MoveProbs(int k, int cityX, bool[] visited, double[][] pheromones, int[][] dists)
        {
       ...
       public static int[][] MakeGraphDistancesDemo(int numCities)
        {
        ...
        public static int[][] MakeGraphDistances(int numCities,List<List<int>> distances)
        {
            int[][] dists = new int[numCities][];
            for (int i = 0; i < dists.Length; ++i)
                dists[i] = new int[numCities];
            for (int i = 0; i < numCities; ++i)
                for (int j = i + 1; j < numCities; ++j)
                {
                    ...
                    dists[j][i] = distances[j][i];
                }
            return dists;
        }

        public static double Distance(int cityX, int cityY, int[][] dists)
        {
       ...
       public static string Display(int[] trail)
        {
       ...
       public static void ShowAnts(int[][] ants, int[][] dists)
        {
       ...
       public static void Display(double[][] pheromones)
        {
            for (int i = 0; i < pheromones.Length; ++i)
            {
                Console.Write(i + ": ");
